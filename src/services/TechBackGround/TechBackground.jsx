...
// import React from 'react'; // Removed unused hooks for cleaner code
// import { useSelector } from 'react-redux';
...
// // --- CONFIGURATION MAP ---
// // This maps the hex codes we chose earlier to specific Labels and Icons
// const THEME_CONFIG = {
//   "#1a1a2e": { label: "WELCOME", icon: MonitorIcon },       // Violet
//   "#16213e": { label: "BROWSE", icon: GamepadIcon },        // Charcoal
//   "#0f3460": { label: "TOURNAMENT", icon: TrophyIcon },     // Blue
//   "#2e1a1a": { label: "LIVE STREAM", icon: RadioIcon },     // Maroon/Red
//   "#1a2e2e": { label: "COMMUNITY", icon: GamepadIcon },     // Teal
//   // Default fallback
//   "default": { label: "SYSTEM", icon: MonitorIcon }
// };

// const TechBackground = () => {
//   // 1. Get Color from Redux (Ensure it matches your store slice name)
//   // Check if your store slice is named 'ui' or 'techBackground'
//   const color = useSelector(state => state.ui?.backgroundColor || state.techBackground?.color || "#1a1a2e");

//   // 2. Determine the current theme based on the color
//   const currentTheme = THEME_CONFIG[color] || THEME_CONFIG["default"];
  
//   // 3. Extract the Icon component to be rendered
...
//   // --- REUSABLE COMPONENT: FAKE GLOW PATH ---
//   const GlowPath = ({ d, strokeWidth = 2, opacity = 1 }) => (
//     <g>
//         <path d={d} strokeWidth={strokeWidth * 4} opacity={opacity * 0.15} strokeLinecap="round" strokeLinejoin="round" />
//         <path d={d} strokeWidth={strokeWidth} opacity={opacity} strokeLinecap="round" strokeLinejoin="round" />
...
//   // --- TOP LEFT CIRCUIT (With Hub) ---
//   const TopLeftCircuit = () => (
//     <g>
//         {/* --- Bold Hex Hub (Anchored) --- */}
//         <g>
//             <GlowHex points={createHexagon(0, 0, 80)} strokeWidth={2.5} opacity={1} />
//             <GlowHex points={createHexagon(0, 0, 70)} strokeWidth={1} opacity={0.8} />
//             <GlowHex points={createHexagon(0, 0, 60)} strokeWidth={1.5} opacity={0.8} />
...
//   // --- BOTTOM RIGHT CIRCUIT (Joined at Origin) ---
//   const BottomRightCircuit = () => (
//     <g>
//         {/* --- Main Trunk (The "Single Branch" Source) --- */}
//         <GlowPath d="M0,0 L60,0" strokeWidth={3} />
//         <circle cx="0" cy="0" r="6" fill="currentColor" />

//         {/* --- Branches to Buses --- */}
//         <g>
//             {/* Connect Trunk to Bus 1 */}
//             <GlowPath d="M60,0 L90,10 L300,10 L350,60 L600,60" strokeWidth={2.5} />
//             <path d="M60,0 L90,25 L295,25 L345,75 L600,75" strokeWidth={1} opacity="0.5" />
//         </g>

//         <g>
//             {/* Connect Trunk to Bus 2 */}
//             <GlowPath d="M40,0 L100,35 L280,35 L330,85 L550,85" strokeWidth={1.5} opacity={0.8} />
//             <path d="M40,0 L100,45 L275,45 L325,95 L550,95" strokeWidth={1} opacity="0.3" />
//         </g>
...
//               <TopLeftCircuit />
//               <g>
//                     <path d="M600,10 L900,10" strokeWidth="1.5" stroke="url(#fade-right)" />
//                     <path d="M600,20 L880,20" strokeWidth="1" stroke="url(#fade-right)" opacity="0.4" />
//               </g>
//             </g>
...
//                     <path d="M500,50 L1920,50" stroke="url(#fade-right)" strokeWidth="1" opacity="0.4" />
//                 </g>
//                 <path d="M550,55 L1800,55" stroke="url(#fade-right)" opacity="0.4" strokeWidth="1" />
//                 <g>
//                     <path d="M0,1040 L1420,1040" stroke="url(#fade-left)" strokeWidth="1.5" />
//                     <path d="M0,1030 L1420,1030" stroke="url(#fade-left)" strokeWidth="1" opacity="0.4" />
//                 </g>
//                 <path d="M100,1025 L1350,1025" stroke="url(#fade-left)" opacity="0.4" strokeWidth="1" />
//             </g>
...
//       {/* --- HUD UI (Fixed Error Here) --- */}
//       <div className="absolute top-[90px] left-[90px] z-20 flex items-center gap-6">
//           {/* Icon centered in the Top-Left Hub */}
//           <div className="flex items-center justify-center w-[60px] h-[60px] text-current transition-colors duration-500" style={{ color: color }}>
//             {/* We now render the dynamically chosen IconComponent */}
//             <IconComponent size={40} color={color} />
//           </div>
          
//           {/* Label Text */}
//           <div className="flex flex-col ml-8 mt-[-20px]">
//             <h1 
//                 className="text-3xl font-black tracking-tighter italic uppercase transition-colors duration-1000"
//                 style={{ 
//                     color: color,
//                     textShadow: `0 0 15px ${color}`
//                 }}
//             >
//                 {/* Dynamically showing the label based on color */}
//                 {currentTheme.label}
//             </h1>
//             <div className="flex items-center gap-2">
//                 <div className="h-1 w-12 bg-current" style={{ color: color }} />
//                 <span className="text-[10px] font-bold tracking-[0.2em] animate-pulse" style={{ color: color }}>SYSTEM READY</span>
//             </div>
//           </div>
//       </div>
